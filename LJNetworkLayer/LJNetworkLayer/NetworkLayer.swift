...
public enum LJ {
    ...
    public static func upload(files: [Upload.FileInfo], toURL url: URL, withHttpMethod httpMethod: HTTPMethod, devKey: String? = nil, completion: @escaping(_ result: Upload.Results, _ failedFiles: [String]?) -> Void) {
